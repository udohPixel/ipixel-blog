      ...
      <div className="py-12">
        <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          {/* <div className="mt-28 mb-16 space-y-2 text-center">
            <h2 className="text-3xl font-bold text-gray-800 md:text-4xl dark:text-white">Welcome to <span className="text-teal-600 dark:text-teal-500">iPixel Blog.</span></h2>
          ...
          <div className="lg:w-3/4 xl:w-3/4 lg:mx-auto">
            ...
            {/* blog card */}
            {blogs && <BlogList blogs={blogs} categories={categories} title="All Blogs" />}
